...
// src/tools/ask-questions.ts
var QuestionsParams = Type.Object({
...
function createAskQuestionsTool(ctx) {
  return defineTool({
    name: "ask_questions",
    label: "Ask Questions",
    description: "Ask clarifying questions when blocked. Posts to the GitHub issue, blocks until answered.",
...
${issue.body ?? ""}` : issue.body ?? "Implement the changes described in the issue."}
...
function createHarnessServer(harness, port) {
